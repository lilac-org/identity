...
<!-- The YAML block above configures the Hugging Face Space. It is ignored
     by GitHub rendering and by the Docker build (README.md is in .dockerignore).
     Remove it if you are not deploying to Hugging Face. -->
